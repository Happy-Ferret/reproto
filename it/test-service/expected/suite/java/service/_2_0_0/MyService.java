...
public interface MyService {
  public static final MethodDescriptor<Void, Void> METHOD_UNKNOWN = 
    MethodDescriptor.<Void, Void>newBuilder()
      ...
      .setFullMethodName(MethodDescriptor.generateFullMethodName("service._2_0_0.MyService", "unknown"))
  ...
  public static final MethodDescriptor<Void, Entry> METHOD_UNKNOWN_RETURN = 
    MethodDescriptor.<Void, Entry>newBuilder()
      .setType(MethodDescriptor.MethodType.UNKNOWN)
      .setFullMethodName(MethodDescriptor.generateFullMethodName("service._2_0_0.MyService", "unknown_return"))
      .setRequestMarshaller(new VoidMarshaller())
  ...
  public static final MethodDescriptor<Entry, Void> METHOD_UNKNOWN_ARGUMENT = 
    MethodDescriptor.<Entry, Void>newBuilder()
      .setType(MethodDescriptor.MethodType.UNKNOWN)
      .setFullMethodName(MethodDescriptor.generateFullMethodName("service._2_0_0.MyService", "unknown_argument"))
  ...
  public static final MethodDescriptor<Entry, Entry> METHOD_UNARY = 
    MethodDescriptor.<Entry, Entry>newBuilder()
      ...
      .setFullMethodName(MethodDescriptor.generateFullMethodName("service._2_0_0.MyService", "unary"))
      .setRequestMarshaller(new JsonMarshaller(new TypeReference<Entry>(){}))
      .setResponseMarshaller(new JsonMarshaller(new TypeReference<Entry>(){}))
      .build();
  ...
  public static final MethodDescriptor<Entry, Entry> METHOD_SERVER_STREAMING = 
    MethodDescriptor.<Entry, Entry>newBuilder()
      ...
      .setFullMethodName(MethodDescriptor.generateFullMethodName("service._2_0_0.MyService", "server_streaming"))
      .setRequestMarshaller(new JsonMarshaller(new TypeReference<Entry>(){}))
      .setResponseMarshaller(new JsonMarshaller(new TypeReference<Entry>(){}))
      .build();
  ...
  public static final MethodDescriptor<Entry, Entry> METHOD_CLIENT_STREAMING = 
    MethodDescriptor.<Entry, Entry>newBuilder()
      ...
      .setFullMethodName(MethodDescriptor.generateFullMethodName("service._2_0_0.MyService", "client_streaming"))
      .setRequestMarshaller(new JsonMarshaller(new TypeReference<Entry>(){}))
      .setResponseMarshaller(new JsonMarshaller(new TypeReference<Entry>(){}))
      .build();
  ...
  public static final MethodDescriptor<Entry, Entry> METHOD_BIDI_STREAMING = 
    MethodDescriptor.<Entry, Entry>newBuilder()
      ...
      .setFullMethodName(MethodDescriptor.generateFullMethodName("service._2_0_0.MyService", "bidi_streaming"))
      .setRequestMarshaller(new JsonMarshaller(new TypeReference<Entry>(){}))
      .setResponseMarshaller(new JsonMarshaller(new TypeReference<Entry>(){}))
      .build();
  ...
  static class ClientStub extends AbstractStub<ClientStub> {
     ...
     * </pre>
     */
    StreamObserver<Void> unknown(final StreamObserver<Void> observer) {
     ...
     * </pre>
     */
    StreamObserver<Void> unknownReturn(final StreamObserver<Entry> observer) {
     ...
     * </pre>
     */
    StreamObserver<Entry> unknownArgument(final StreamObserver<Void> observer) {
     ...
     * </pre>
     */
    void unary(final Entry request, final StreamObserver<Entry> observer) {
     ...
     * </pre>
     */
    void serverStreaming(final Entry request, final StreamObserver<Entry> observer) {
     ...
     * </pre>
     */
    StreamObserver<Entry> clientStreaming(final StreamObserver<Entry> observer) {
     ...
     * </pre>
     */
    StreamObserver<Entry> bidiStreaming(final StreamObserver<Entry> observer) {
  ...
  abstract static class ServerStub implements BindableService {
    ...
    public ServerServiceDefinition bindService() {
      return ServerServiceDefinition
        .builder("service._2_0_0.MyService")
